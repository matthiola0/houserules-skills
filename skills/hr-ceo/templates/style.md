...
## Comments (in code)
- Comment language: English.   ← independent of the chat language; see config.md → Language
...
- Prose language: English.   ← independent of the chat language; see config.md → Language
